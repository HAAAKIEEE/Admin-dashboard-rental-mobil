<x-layout>
    <div class="p-4 sm:ml-64">
        ...
        <a href="{{route('add-users')}}"
            class="mb-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            Add User
        </a>
        ...
        <table class="mt-5 drop-shadow-xl w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('edit-users', $user->id) }}" class="text-blue-600 hover:underline">Edit</a>
                        <form action="{{ route('destroy-users', $user->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
